...
<p align="center">
    <h1 align="center">PRODIGY_INTERN</h1>
</p>
<!-- <p align="center">
    <em>HTTP error 401 for prompt `slogan`</em>
</p> -->
<!-- <p align="center">
	<img src="https://img.shields.io/github/license/vasanth-boyez/Prodigy_Intern.git?style=flat&color=0080ff" alt="license">
	<img src="https://img.shields.io/github/last-commit/vasanth-boyez/Prodigy_Intern.git?style=flat&logo=git&logoColor=white&color=0080ff" alt="last-commit">
	<img src="https://img.shields.io/github/languages/top/vasanth-boyez/Prodigy_Intern.git?style=flat&color=0080ff" alt="repo-top-language">
	<img src="https://img.shields.io/github/languages/count/vasanth-boyez/Prodigy_Intern.git?style=flat&color=0080ff" alt="repo-language-count">
<p> -->
<p align="center">
...
>   - [🤖 Running Prodigy_Intern](#-running-Prodigy_Intern)
>   - [🧪 Tests](#-tests)
...
<p><h1><b>Prodigy Intern Tasks</b></h1> 

## Introduction 

Thanks for visiting the Prodigy Intern project repository! The repository contains the progress made during my Prodigy Infotech internship where I implemented a number of machine learning exercises using various Kaggle datasets. In the subsequent paragraphs, I will summarize the tasks I undertook, the methods I used, and when and where I encountered challenges. 

### Overview of Tasks 

1. **House Price Prediction** 
    - **Objective:** Predict the price of the house using the square feet of the house, the number of bedrooms and bathrooms, etc. 
    - **Methods:** Linear regression, feature selection, and data pre-processing. 

2. **Customer Segmentation** 
    - **Objective:** Create customer groups based on the purchase history of customers at a retail store. 
    - **Methods:** K-means clustering, feature engineering, and data visualization. 
3. **Image Classification of Cats and Dogs**
   - **Objective:** Classify images of cats and dogs.
   - **Techniques:** Support vector machine (SVM), image preprocessing, and feature extraction.

4. **Hand Gesture Recognition**
   - **Objective:** Identify and classify different hand gestures from image or video data.
   - **Techniques:** Deep learning, data normalization, and model training.

5. **Food Item Recognition and Calorie Estimation**
   - **Objective:** Recognize food items from images and estimate their calorie content.
   - **Techniques:** Convolutional neural networks (CNNs), image augmentation, and model evaluation.

### Key Outcomes

- **Predictive Models:** Developed robust models for predicting house prices and recognizing food items.
- **Clustering and Segmentation:** Successfully implemented clustering algorithms to segment customer data.
- **Image Classification:** Achieved high accuracy in classifying images of cats, dogs, and hand gestures.
- **Feature Engineering and Extraction:** Enhanced model performance through effective feature engineering and extraction techniques.

### Conclusion

This repository demonstrates the application of various machine learning models to address distinct real-world problems. The projects provided valuable hands-on experience in data preprocessing, model implementation, and evaluation. 

Feel free to explore the code and datasets provided for each task. Contributions and suggestions are welcome!

---

## Acknowledgments

I would like to thank Prodigy Infotech for the opportunity to work on these exciting projects. 
...
1. **Comprehensive Data Preprocessing**
   - Data cleaning, normalization, standardization, and categorical encoding.

2. **Feature Engineering**
   - Feature selection and creation to enhance model performance.

3. **Machine Learning Models**
   - Implementing linear regression, K-means clustering, SVMs, and CNNs for various predictive and classification tasks.

4. **Model Evaluation and Validation**
   - Using performance metrics (accuracy, precision, recall, F1-score, MAE, R-squared) and cross-validation techniques.

5. **Data Visualization**
   - EDA with Matplotlib and Seaborn, cluster visualization.

6. **Documentation and Reporting**
   - Comprehensive task documentation and a detailed README file.
...
└── Prodigy_Intern/
    ...
    │   │   │   ├── 45OQyZuXtfNCc8Rk.png
    │   │   │   ├── 45ho1tx7W1LZB0DU.png
    │   │   │   ├── 460WcktBwCAzsU0A.png
    │   │   │   ├── 4Bimc2E5E9jTh1Fh.png
    │   │   │   ├── 4Fxr7klOIfijCpio.png
    │   │   │   ├── 4IwJ2iL6pFz5ARWA.png
    │   │   │   ├── 4Pir885YNPXiRs0R.png
    │   │   │   ├── 4ZoU4nouZzb9G2MI.png
    │   │   │   ├── 4aWP3XumkgwZtqZ7.png
    │   │   │   ├── 4bkmUMq0wOXElBIl.png
    │   │   │   ├── 4dpYSXpjYbiH9MSq.png
    │   │   │   ├── 4fCqIVTEuFLsQMaZ.png
    │   │   │   ├── 4hcthlc3eCByBJFh.png
    │   │   │   ├── 50Wjlq1jW7o3wcl8.png
    │   │   │   ├── 52nvTykEONIdmqQI.png
    │   │   │   ├── 54xah1BB0YTQS3Ib.png
    │   │   │   ├── 5Cy2fFOaWMFwa5iu.png
    │   │   │   ├── 5FVy5hSvZ9c0M2Y5.png
    │   │   │   ├── 5Iz9WPYz1C3PKWxj.png
    │   │   │   ├── 5NsmQol0TP7h80bh.png
    │   │   │   ├── 5RvFm2PYoG18yIZO.png
    │   │   │   ├── 5U8st2LCr9zLl5og.png
    │   │   │   ├── 5eRezaxzYX8Canq0.png
    │   │   │   ├── 5jcXrtjEVtQwI0Wa.png
    │   │   │   ├── 5kJec3v9txvrAb4g.png
    │   │   │   ├── 68QZtdP6UaIcIE55.png
    │   │   │   ├── 6BIKQpfZEfQkCvrz.png
    │   │   │   ├── 6NzgMmSELzk3WtZh.png
    │   │   │   ├── 6OhEpnz0QxBCfbXE.png
    │   │   │   ├── 6q2PxM8Kk16UxoMY.png
    │   │   │   ├── 6wuALDd920vZ0qZE.png
    │   │   │   ├── 6ycslJxTsTjZc5H2.png
    │   │   │   ├── 73UfZ8Dwj0OB66IV.png
    │   │   │   ├── 74FZPuPPfVCwqHgO.png
    │   │   │   ├── 755DbuyE4rf2oGPA.png
    │   │   │   ├── 77rce5yVvVPIPmp8.png
    │   │   │   ├── 7I1fABs6SL1T4MNb.png
    │   │   │   ├── 7IYZ788SAadhvemj.png
    │   │   │   ├── 7L3Xke8iQBzywEPH.png
    │   │   │   ├── 7NyxZyxSJ1gphzUE.png
    │   │   │   ├── 7PSJU8kbZf8S6FRW.png
    │   │   │   ├── 7Px9USAD7J56woB0.png
    │   │   │   ├── 7UoLr02FuYuLrJxz.png
    │   │   │   ├── 7Vor5Uo4DweXkpE7.png
    │   │   │   ├── 7YbjJFHGHPhJQFvE.png
    │   │   │   ├── 7ZGsbIMypDIEZxR0.png
    │   │   │   ├── 7fRLxoheLluOwCkp.png
    │   │   │   ├── 7v943QrV87m1Fx5U.png
    │   │   │   ├── 7w91NsCtVzsPOSYB.png
    │   │   │   ├── 821xYeW8U0Iy6qVX.png
    │   │   │   ├── 84JL84r6Jcpp5Udi.png
    │   │   │   ├── 89dWYgfIZm624Pf6.png
    │   │   │   ├── 8I8hrFbPPNz6qWeV.png
    │   │   │   ├── 8NNPWO3e2oNq8lg9.png
    │   │   │   ├── 8X1BUL9w2OMExPy5.png
    │   │   │   ├── 8cUuoeM7qSsAGoOv.png
    │   │   │   ├── 8q4xxTvBVnXTRSQy.png
    │   │   │   ├── 8qhPJIViAhfZTJkA.png
    │   │   │   ├── 8vCpdCGSnX8CopJJ.png
    │   │   │   ├── 90GH8JQWUw9PUnlA.png
    │   │   │   ├── 9Dto1OCNf5wjYimE.png
    │   │   │   ├── 9GnoYJhsreNoV2Wn.png
    │   │   │   ├── 9OyGmAsWD5Ie6QIa.png
    │   │   │   ├── 9RmM1chbNsDKXXlg.png
    │   │   │   ├── 9WQaDoiIDC4zGPr8.png
    │   │   │   ├── 9bQFlg61mt0akPoM.png
    │   │   │   ├── 9giVcOVtFf85mQZd.png
    │   │   │   ├── 9hKJu3ZMso4Qbtfh.png
    │   │   │   ├── 9qKKOliWXD7oDZOd.png
    │   │   │   ├── 9rwmakEj6Wg1YQWW.png
    │   │   │   ├── 9szmJOWlXxEbjDGV.png
    │   │   │   ├── 9v75qnx8zdeAAOq6.png
    │   │   │   ├── 9xyvz1JbPwNqtLgH.png
    │   │   │   ├── 9yGlnLxGtzq1gJti.png
    │   │   │   ├── 9zfyVkUcku0qc4Gu.png
    │   │   │   ├── 9zuFLFklb0ibEelE.png
    │   │   │   ├── A0Dgq561RAiluT9p.png
    │   │   │   ├── ACUZLBMxCu3AWgUu.png
    │   │   │   ├── AMewmfMVCnLfbuNr.png
    │   │   │   ├── ATs4aFUIODixPnMI.png
    │   │   │   ├── AYfr1pZxmZyZaXWu.png
    │   │   │   ├── Af7KstxKjdhzUQyk.png
    │   │   │   ├── AfvIbTwxuG0q7Ij1.png
    │   │   │   ├── AjwddXm0ttm7Ts5J.png
    │   │   │   ├── AqNY2b7NX9Ce3CjZ.png
    │   │   │   ├── Arbkrts1pXpDNgFV.png
    │   │   │   ├── AtfMvZ19yfJJZapD.png
    │   │   │   ├── B08mrGoODd5gGTvu.png
    │   │   │   ├── B3dlyiRDulDJWOsW.png
    │   │   │   ├── B6dJfDThlXx80Uk6.png
    │   │   │   ├── B9PzXQbhzehhxFRN.png
    │   │   │   ├── B9WSmSgclFPB3TOL.png
    │   │   │   ├── BH9zAUdmmjlfXwtS.png
    │   │   │   ├── BI9YnLkJ5wFZe6w8.png
    │   │   │   ├── BLqL31aC5YLmx3uF.png
    │   │   │   ├── BTG0fjXM09DyD4sh.png
    │   │   │   ├── BVfw3Er2AUBqREYJ.png
    │   │   │   ├── BbOoLEGslGMBu7sj.png
    │   │   │   ├── BfFGJgByTJnxADwA.png
    │   │   │   ├── BoMfAmQYWtoiGHBV.png
    │   │   │   ├── BoXJ7o2SeSRRfuAH.png
    │   │   │   ├── BqGdYFfhQ4sOU5Xl.png
    │   │   │   ├── C0WynzBAhXQGSywJ.png
    │   │   │   ├── C3j6RdTEo4jf6Cr4.png
    │   │   │   ├── C5LDaiOquQm9mDVH.png
    │   │   │   ├── C7zCG474LseZgn8o.png
    │   │   │   ├── C9tAvywdtjDTnllg.png
    │   │   │   ├── CHf3O6SDtuPbbD0s.png
    │   │   │   ├── CIN4oPYURMvc4xTb.png
    │   │   │   ├── CJ3BCSOVp8uzaPnY.png
    │   │   │   ├── COmibsBioPBur0V9.png
    │   │   │   ├── CbiqUiChqkXHb8jk.png
    │   │   │   ├── ClP1hwm5k2IQsG1B.png
    │   │   │   ├── CnRjJejRPD3QmYTl.png
    │   │   │   ├── CpDMCILKUN2AUA1A.png
    │   │   │   ├── CrEzO2508GiIMFrx.png
    │   │   │   ├── Cto0fRvS0ns9lVrs.png
    │   │   │   ├── CwFaCN3ykqwQ6KZV.png
    │   │   │   ├── Cx9G4YyKPI9MPcqp.png
    │   │   │   ├── CxcQ3XRBjkkmZ9b8.png
    │   │   │   ├── D3mbFhVy7zFkZEtV.png
    │   │   │   ├── D9nbrQLDSgDMNh3G.png
    │   │   │   ├── DBriMZZSZtYea72l.png
    │   │   │   ├── DDHIkmyeaJPV7k0A.png
    │   │   │   ├── DE5gewqrqzSaVsdI.png
    │   │   │   ├── DGR6Jkl5GJY9Sez0.png
    │   │   │   ├── DOuDihjhzIuZ2skd.png
    │   │   │   ├── Di7hVJMSS3DzbSTi.png
    │   │   │   ├── DsaaqkHZUN3pmcwH.png
    │   │   │   ├── Dvamqz9JlSMySW1i.png
    │   │   │   ├── E10FR2TKbBsv9Hgm.png
    │   │   │   ├── E4TyifCgPm6OwcrY.png
    │   │   │   ├── EJ42U85HcmJV7JVm.png
    │   │   │   ├── EJ7cNnnea5yCEaOd.png
    │   │   │   ├── EVtIRpfQ2ys2A3ag.png
    │   │   │   ├── Ea6A81oe4Ria2MW3.png
    │   │   │   ├── Ec6WrF6Soj4REPk7.png
    │   │   │   ├── Eq9tohFHMpYXWQZH.png
    │   │   │   ├── EuU83pQABhf4v0AF.png
    │   │   │   ├── FEdPo8Z0t3bB1hHC.png
    │   │   │   ├── FJoRrTDakCLyWs75.png
    │   │   │   ├── FKhLHIIqEsYmoZxy.png
    │   │   │   ├── FT9FiK5l1lohzfxI.png
    │   │   │   ├── FVEAFUE9uhfJPi2f.png
    │   │   │   ├── FcIIjteQItMuIuRa.png
    │   │   │   ├── FltCm1ep2lcnsOYz.png
    │   │   │   ├── FmDdvclwy9Wc1zfc.png
    │   │   │   ├── FqTkhXfEVeaGHReH.png
    │   │   │   ├── FwR0aXsgOZ5KHDjH.png
    │   │   │   ├── FxLuxwBp9Hw2th2O.png
    │   │   │   ├── G4QepYlFnpE8Zse4.png
    │   │   │   ├── Gc4hUsoFAQBdulGg.png
    │   │   │   ├── GelC88IvDZoRejHp.png
    │   │   │   ├── Gv71lr2m5b9rBwPy.png
    │   │   │   ├── H8cGdqeAOdIyIMO5.png
    │   │   │   ├── H8n0niVYdIGNGE0d.png
    │   │   │   ├── HIo7Eax3OPP5MuXl.png
    │   │   │   ├── HQSUE6P23pvLctuy.png
    │   │   │   ├── HTETrKtTEB31pvsK.png
    │   │   │   ├── HTSIUeIA1IQrHtHu.png
    │   │   │   ├── HU7Q4utMI0vHMxlh.png
    │   │   │   ├── HXxUlm3O2djcDgUR.png
    │   │   │   ├── HYIh5ipF4bN1futQ.png
    │   │   │   ├── HarpXSxVfoAJ9cFe.png
    │   │   │   ├── HbBcQItQ6d5yMDqL.png
    │   │   │   ├── HkBUo9kQDJho4uor.png
    │   │   │   ├── Ht08RX3DQCSdl9Sy.png
    │   │   │   ├── Httje79JB2p6ePf0.png
    │   │   │   ├── HuunhhoTMXTrST2Z.png
    │   │   │   ├── HvQdmFU7Qzd4SSQ4.png
    │   │   │   ├── HyLg8tH9blwT6eVy.png
    │   │   │   ├── IKy6sz5i68TYNJH6.png
    │   │   │   ├── IQsx834hZ2POqopO.png
    │   │   │   ├── ISW7mRK3Wu6ik0eH.png
    │   │   │   ├── IXh9BTFQQ6AIaBpr.png
    │   │   │   ├── Ih5Z5Z3xFZ17IcZS.png
    │   │   │   ├── IkSLcJtq4O6iBmE4.png
    │   │   │   ├── IlrxPx0XNL2QslmW.png
    │   │   │   ├── IxQ1CVKgnpiD0HfY.png
    │   │   │   ├── JApmimWQx0vFx1qw.png
    │   │   │   ├── JDZ86cNk15r0NTi6.png
    │   │   │   ├── JFOcfFSm3Ul0Xkha.png
    │   │   │   ├── JKN8VKp7pfMEQdBZ.png
    │   │   │   ├── JOsGCJTsKvKGNHN1.png
    │   │   │   ├── JQaNQ7LsPy3cY23Q.png
    │   │   │   ├── JRZTPL2YQ6cfIMh9.png
    │   │   │   ├── JUn3VuVCoOKC5Nv2.png
    │   │   │   ├── JZ8KCFK6y0Zd87Xl.png
    │   │   │   ├── JbnPCQTbu7AS9jvo.png
    │   │   │   ├── Je4YZuaXlY4KaAfQ.png
    │   │   │   ├── JlMP0YH6vhxWRMZz.png
    │   │   │   ├── JsrOSaR3txTRu3I9.png
    │   │   │   ├── JsryGUQahbbNkrlP.png
    │   │   │   ├── K6IACWoiTOnGR9Np.png
    │   │   │   ├── K8WJMHr1iCttaMbB.png
    │   │   │   ├── KAoLE5XBuwjmtKj2.png
    │   │   │   ├── KAyKztBfGIWm4qN7.png
    │   │   │   ├── KGiyDw5Ryx3WjjSZ.png
    │   │   │   ├── KHfp6LJDEhqbcomR.png
    │   │   │   ├── KJ77yLPN943SrPZW.png
    │   │   │   ├── KOlOsNsrUdQonYpp.png
    │   │   │   ├── KPJ371erJ0RUKNAX.png
    │   │   │   ├── KSueOZE0QWbJClvK.png
    │   │   │   ├── Klcu8qBjVs676hic.png
    │   │   │   ├── KqCGmJ8WCrqE5Uvg.png
    │   │   │   ├── L2S17RtFi8XXp6b8.png
    │   │   │   ├── L2oIlMxDTToJYUvV.png
    │   │   │   ├── LAhqdrhPNg3ZLxpr.png
    │   │   │   ├── LEA78quc0fi2hq9W.png
    │   │   │   ├── LI47bUY9rR60z73q.png
    │   │   │   ├── LYirpnRmbCGN6T7O.png
    │   │   │   ├── LhgH8QOKfA5xu287.png
    │   │   │   ├── LkNkNVjTRm5Gr9NQ.png
    │   │   │   ├── Lmx5I567tGyQ9HYi.png
    │   │   │   ├── LpASHQ03atiBeyRw.png
    │   │   │   ├── Lq77eAG8OPaizwEd.png
    │   │   │   ├── LqxEdPczGbYd9Zlu.png
    │   │   │   ├── LrVULgPLsLsfdZ2z.png
    │   │   │   ├── Lui3J5YhKgMvk673.png
    │   │   │   ├── Lwd11NDu17odCiv7.png
    │   │   │   ├── M4h0o8DAzyOpmgSM.png
    │   │   │   ├── MBCdeYSw1CGsIlHf.png
    │   │   │   ├── MJAUydLSEPqZHwPz.png
    │   │   │   ├── MKe2ciaSOmdDH1JK.png
    │   │   │   ├── MKnNPdRtHfgr6ZbI.png
    │   │   │   ├── MLURv7NBoSPK4f1h.png
    │   │   │   ├── MLrUGD1graoSw2c5.png
    │   │   │   ├── Miw8prUoiVMVG2D4.png
    │   │   │   ├── MmzlgKI366LYX3fe.png
    │   │   │   ├── MnvVVMoqDmzrm5NJ.png
    │   │   │   ├── Mq8Ym2axOJVIthiP.png
    │   │   │   ├── Mv6oOH192gse3oZA.png
    │   │   │   ├── N3RjXoHuCkTs2Prd.png
    │   │   │   ├── N4D5tleMLbP1Au5D.png
    │   │   │   ├── N5JmBjeptZ3hK3EK.png
    │   │   │   ├── NKNFgMn2Ik3Y9XuX.png
    │   │   │   ├── NLwrHPTaiNSMjHLX.png
    │   │   │   ├── NS5CJKNsJa9jr5j4.png
    │   │   │   ├── Nm8PHXHrGlZy0d6Q.png
    │   │   │   ├── NnWvTxntBJ5mFY73.png
    │   │   │   ├── NwbFl4nQqE5pm5PZ.png
    │   │   │   ├── O0fq1v7s6qxN8o9L.png
    │   │   │   ├── O4H6QPX8bdwNiIie.png
    │   │   │   ├── OEFttKrmyc4bGb54.png
    │   │   │   ├── OJpDyt2u6zzfoVP0.png
    │   │   │   ├── OMq2VJyb0KwtdwDc.png
    │   │   │   ├── OSEIPDjPzHw3gKjc.png
    │   │   │   ├── OXA4uaaO7YUkxjSJ.png
    │   │   │   ├── ObnNNP8S6dH3IxIS.png
    │   │   │   ├── OdfDTwgPVdW9XbE7.png
    │   │   │   ├── OhkFvTOiBqphyG0I.png
    │   │   │   ├── Om6b4BvZS49QNNFV.png
    │   │   │   ├── P0BIztnCzZ3StLD1.png
    │   │   │   ├── P1STllnKDD05zo29.png
    │   │   │   ├── PDV8vSlSFdej3jNx.png
    │   │   │   ├── PLvidx6rZDuRENbv.png
    │   │   │   ├── PTjpGk2rKf6mhx9z.png
    │   │   │   ├── PZrfX01MvfB3oeyB.png
    │   │   │   ├── PaZSkEO4jbBp3Hz7.png
    │   │   │   ├── PbqPTUSB4HxBVDZZ.png
    │   │   │   ├── PwkqvoT0noMITNaF.png
    │   │   │   ├── Q8idpb4gCSAWs9YH.png
    │   │   │   ├── QASICiZe79sFTXBz.png
    │   │   │   ├── QCHltvmva5vmGrPo.png
    │   │   │   ├── QCqvYDzuP0z3omox.png
    │   │   │   ├── QKFJL22hutlivVGa.png
    │   │   │   ├── QLXEsveWG3vywKfy.png
    │   │   │   ├── QQksMNb2czxqfTF8.png
    │   │   │   ├── QUcJ1QclQwOY50vY.png
    │   │   │   ├── QVFB67Eza3BCNeRY.png
    │   │   │   ├── QVIiXr87PkeldzZM.png
    │   │   │   ├── QWT9FOhLABPyKIUA.png
    │   │   │   ├── QZtii0ogsjl6hxun.png
    │   │   │   ├── Qbn4RJqessetWPHR.png
    │   │   │   ├── QnjBVl6cFnyd2hVF.png
    │   │   │   ├── QqPSoi6Vj2Vbua3V.png
    │   │   │   ├── Qx31hf6YWyFs6Mu7.png
    │   │   │   ├── Qxx5l8WCNBjMb5xI.png
    │   │   │   ├── R2Hq3bL46kah8D9n.png
    │   │   │   ├── R7y8PxDKzaAd0uUQ.png
    │   │   │   ├── RFXW2X1DlH7xboth.png
    │   │   │   ├── RJrQJX31bej6flMr.png
    │   │   │   ├── RQ78Zpf7uYHXCYcb.png
    │   │   │   ├── RW8BP64V5NC04QWf.png
    │   │   │   ├── RlpqfQnTgM6AxUNs.png
    │   │   │   ├── RmJmYq6VCNrrvi2l.png
    │   │   │   ├── RmTijOM3U31zKnrY.png
    │   │   │   ├── RqdXcCyqmXMxSDxn.png
    │   │   │   ├── RtFKKjIDZ0zA0khp.png
    │   │   │   ├── Rxmuq5Y6dw22QESt.png
    │   │   │   ├── SDQQfzHl47yNqA6K.png
    │   │   │   ├── SPx9aUguwNqxqPVS.png
    │   │   │   ├── SboHPaPEPBqkkTUX.png
    │   │   │   ├── SjE9MULuPPnbplHT.png
    │   │   │   ├── SjtYrw48VCBOLOQh.png
    │   │   │   ├── SoqluLecSTBcuyoS.png
    │   │   │   ├── SrSUeH255dybz2zi.png
    │   │   │   ├── SsvKZDW23vRQMUtA.png
    │   │   │   ├── StyclBeCFwYGuttl.png
    │   │   │   ├── Su03KsBNHrCVUXli.png
    │   │   │   ├── TYjJigXjEyiVntzx.png
    │   │   │   ├── TcybcTuKdMPA4xpT.png
    │   │   │   ├── Tgy8eMKf7vZc4Eib.png
    │   │   │   ├── TlnoQ46NyW8oZV07.png
    │   │   │   ├── TmPdVzKg9yHUefja.png
    │   │   │   ├── TnoLyTMw8xPdz0ck.png
    │   │   │   ├── TstngIvuLJt0GIze.png
    │   │   │   ├── TzhAea8QXqJwqpUY.png
    │   │   │   ├── U2InMVDH10R24eOb.png
    │   │   │   ├── U3XlUGS4C4YGpjGP.png
    │   │   │   ├── U5WsclDnMxnOTgGT.png
    │   │   │   ├── UCZlOkcylNYU2ylP.png
    │   │   │   ├── UE6Ao0ZqJbQ1R1R5.png
    │   │   │   ├── UGHu0zv6pWOmgBWn.png
    │   │   │   ├── UHyVkisiFMmasl7b.png
    │   │   │   ├── UJXhVbWUgUnzedxP.png
    │   │   │   ├── UJdZdj6nyFRHVFEg.png
    │   │   │   ├── UN3iCDyiEIteIMdx.png
    │   │   │   ├── UOW45qbyvti8nBHV.png
    │   │   │   ├── UQIJiOYi6zCaIeue.png
    │   │   │   ├── URj0hmH1Y9lNObL9.png
    │   │   │   ├── UVuauoFm9Pk5JJre.png
    │   │   │   ├── UWq276y40jnVYaPC.png
    │   │   │   ├── UmipL2kv9TdDdryZ.png
    │   │   │   ├── Uok6jb9ObZxSWCDu.png
    │   │   │   ├── UqMn3TJPZRf0px46.png
    │   │   │   ├── UuF8mRQ3FDM6fOmp.png
    │   │   │   ├── UvFHqrnEwsrs6MgC.png
    │   │   │   ├── V3Z0tEoM7Cq761eZ.png
    │   │   │   ├── V7gDBwuUctk8myTw.png
    │   │   │   ├── V9v5VHsYgQOVnzo2.png
    │   │   │   ├── VD4twqBeFDIHSovy.png
    │   │   │   ├── VFOCgVBUlL5Gp4Hh.png
    │   │   │   ├── VUx1G75w9CbeAJUx.png
    │   │   │   ├── VfIYGbOFu36N6MDw.png
    │   │   │   ├── Vly5xEFupx36kCcd.png
    │   │   │   ├── VrhvQlf5Yz5mAt7Y.png
    │   │   │   ├── VstDOeRm7czrAOO9.png
    │   │   │   ├── W4QtOYoG8ThbcmsY.png
    │   │   │   ├── W79peyAyfQqNP1vF.png
    │   │   │   ├── WOMFIvaWB3TEY6Gl.png
    │   │   │   ├── WUJ02oAbtzoPF4oo.png
    │   │   │   ├── WVfwcOw6nXcg4xER.png
    │   │   │   ├── Wcg4nsnlWrhxgyJg.png
    │   │   │   ├── WejRez1oUWm5lhuw.png
    │   │   │   ├── X3iDu3E3UCW1w1Cd.png
    │   │   │   ├── X5YjuJk3mrupKDrG.png
    │   │   │   ├── XCoWpNiWscJm476F.png
    │   │   │   ├── XF9I4tnxCvI7XzIG.png
    │   │   │   ├── XJlnAmd0Rb4GNRxm.png
    │   │   │   ├── XNUalPNmCkHhYk1i.png
    │   │   │   ├── XOWPFbuwpaJaEv9o.png
    │   │   │   ├── XPvzu0bXUw8THjbU.png
    │   │   │   ├── XQihGnpPBb3DucOm.png
    │   │   │   ├── XnvU9UjrhVwfnSgj.png
    │   │   │   ├── Xr1e0JehAkRxNzTj.png
    │   │   │   ├── Y0XtXW0pn979O6KK.png
    │   │   │   ├── Y7DDimLAYeU323au.png
    │   │   │   ├── Y8kfG3f6KJa1YJPA.png
    │   │   │   ├── YEGCpdShhdOdneq4.png
    │   │   │   ├── YTZfr87ETKYNkQRN.png
    │   │   │   ├── YaRk8v83K7BQmi5G.png
    │   │   │   ├── YkZMyyS9fJdKmL3F.png
    │   │   │   ├── YnANqAVHDOylhBls.png
    │   │   │   ├── YrEfjld9tYk0b9m9.png
    │   │   │   ├── Z4HE3jW7SMOonYFA.png
    │   │   │   ├── Z5ioSnqxnoCUixRW.png
    │   │   │   ├── Z9vSGzBQ8YLOXQIX.png
    │   │   │   ├── ZBA0HPVlxkCdle5v.png
    │   │   │   ├── ZFMh222FMJzr0yLD.png
    │   │   │   ├── ZGLUqWHjarBly23b.png
    │   │   │   ├── ZGQV7rFVePreAdOe.png
    │   │   │   ├── ZULuRlvYzTJM8jC3.png
    │   │   │   ├── Ze6bn38U5XECyORF.png
    │   │   │   ├── ZjHU1M9wOwgrm7SX.png
    │   │   │   ├── ZnuLAMdyI9xJCcKE.png
    │   │   │   ├── Zo0eTAGaUb4ewSkf.png
    │   │   │   ├── ZtLFRBgHAyauXYW6.png
    │   │   │   ├── ZveWRNmdKejc1c4w.png
    │   │   │   ├── Zx5NMbS4YBf29guF.png
    │   │   │   ├── a0CaFEDoDB7qeyhN.png
    │   │   │   ├── a21pgCIQ9pl0Guv5.png
    │   │   │   ├── a45DJKHJdnCFhX5X.png
    │   │   │   ├── a9SyLOjQZE4llCvX.png
    │   │   │   ├── aICabYNb79bdS6Mu.png
    │   │   │   ├── aINwMVFw8UopgTOm.png
    │   │   │   ├── aJeRqPY3UVBErDTY.png
    │   │   │   ├── aKUFn8PEF7LP8BaX.png
    │   │   │   ├── aOiWbMZF8BhxwLTs.png
    │   │   │   ├── aac4C8FFlVQw6aGM.png
    │   │   │   ├── ac0j8jCfz8hwpY0o.png
    │   │   │   ├── aeVtGl2LQBr831P5.png
    │   │   │   ├── af6U4DsLPicCZcED.png
    │   │   │   ├── atICt4otp6p6h31G.png
    │   │   │   ├── av2NxK494nd72Q13.png
    │   │   │   ├── aw7H9dMuThRnO74k.png
    │   │   │   ├── axwcCc4rC8ySUtML.png
    │   │   │   ├── b15QGB4XPECDemV5.png
    │   │   │   ├── b8dw4ZOgMTx2h1xI.png
    │   │   │   ├── bPTh8OjfiaJfzdcw.png
    │   │   │   ├── bQO2dBIReHsgMCBi.png
    │   │   │   ├── bTurr7qf07hoPQu1.png
    │   │   │   ├── bWjObTeNghy8Z1zE.png
    │   │   │   ├── bddldJIGmQP5CSLD.png
    │   │   │   ├── bxn0wMR4QebqVl62.png
    │   │   │   ├── byBLmTC0iWfnT7wo.png
    │   │   │   ├── c4FpTJmUl8wtm4n3.png
    │   │   │   ├── cI2tl5vM2koXZPfG.png
    │   │   │   ├── cMbbpVIgFU95R4tO.png
    │   │   │   ├── cOHWfHkyo8sqWnpW.png
    │   │   │   ├── cQ0dBO3yHPohZ9U9.png
    │   │   │   ├── cUFSYeNYdnhRB6MD.png
    │   │   │   ├── cXZYoC2Bu8SeHasE.png
    │   │   │   ├── cf9L4KKsfsFpRrYA.png
    │   │   │   ├── cfCjmEcXysh0H52D.png
    │   │   │   ├── coKLsdqkvkYUv247.png
    │   │   │   ├── crYtjQcVKQjCAWYq.png
    │   │   │   ├── cuDzhxpWujBPgJmX.png
    │   │   │   ├── cw7oAjQLSjDYZPXH.png
    │   │   │   ├── d5FmD95HmhodiITj.png
    │   │   │   ├── dDtRH0QF7IPSsasH.png
    │   │   │   ├── dF7Gvm0vgCJZofAW.png
    │   │   │   ├── dIg7Ds4xEzk0pyWZ.png
    │   │   │   ├── dPSQ4TKPBJyjv6cH.png
    │   │   │   ├── dUDR2ViadkqS6EHf.png
    │   │   │   ├── dZh2VMRu9nRGHhYL.png
    │   │   │   ├── dZxpgHYRuQNv7T7A.png
    │   │   │   ├── dftjUImANb0Q9pMA.png
    │   │   │   ├── djVVgBL6PqTdtr6l.png
    │   │   │   ├── dmT5g2m3meABNfCJ.png
    │   │   │   ├── dyHfn1GBYIj195b5.png
    │   │   │   ├── e50cckZL8BKmqzjd.png
    │   │   │   ├── e6blzPfvGcrcHaKl.png
    │   │   │   ├── e96cq72UJTICTkE0.png
    │   │   │   ├── eASnEW16rlMUPMf3.png
    │   │   │   ├── eBU0DmyWZu3WLjSO.png
    │   │   │   ├── eBjRjXUIy7fpUaRy.png
    │   │   │   ├── eCZWzeGkpX6rdizo.png
    │   │   │   ├── eCpHvcUt4r7A9xJE.png
    │   │   │   ├── eLBTZkvB4E951ml0.png
    │   │   │   ├── eLNpUj2AZ1h4Mrxu.png
    │   │   │   ├── ePEd8TOzTgrGz5M2.png
    │   │   │   ├── eQaNnPaHwKsOJaYq.png
    │   │   │   ├── eW9ezZkV7Jxu1BEk.png
    │   │   │   ├── eaOtD5yLQHTuFTz3.png
    │   │   │   ├── ehzdlf5B1HtVgpRs.png
    │   │   │   ├── eiiwN1DsKoIheMgz.png
    │   │   │   ├── ejC8QIku5jrtci48.png
    │   │   │   ├── em91htnBohvtnG2e.png
    │   │   │   ├── et9oIiGQmAgwy7GK.png
    │   │   │   ├── f1aYiLdB5VC3L8Kk.png
    │   │   │   ├── f423uSEl5slK7nbj.png
    │   │   │   ├── fCX7MPg0xO4QP2Mk.png
    │   │   │   ├── fMkDqtJgZAKa7dl5.png
    │   │   │   ├── fPwDPzGZ5JeY0rb9.png
    │   │   │   ├── fSWSXO9fumLluiAF.png
    │   │   │   ├── fYuJzeeHPzGwlGh0.png
    │   │   │   ├── fiX6rjBt5qHGMsjc.png
    │   │   │   ├── fjITlTb11LELvo3e.png
    │   │   │   ├── fnbn7osMCGWmqHKZ.png
    │   │   │   ├── fwnVVskCSNkB9LUL.png
    │   │   │   ├── g028Qv0lVlEbKi1q.png
    │   │   │   ├── gFqfkMtX39sTkrSB.png
    │   │   │   ├── gO7yxcP6H1vZ7lOe.png
    │   │   │   ├── gR2aEiEX8CzCtyBN.png
    │   │   │   ├── gVd3f9CZNll3QS8l.png
    │   │   │   ├── gpipGA62xfMjfr8O.png
    │   │   │   ├── h4yYJuwG5dUXEY1B.png
    │   │   │   ├── hCPYo6pBGExadl5o.png
    │   │   │   ├── hH7jcOkAiHqNDWcy.png
    │   │   │   ├── hHY3BbYoVFjLEsbd.png
    │   │   │   ├── hUDN2qXDxjoGBWqu.png
    │   │   │   ├── hWVwQVI74lc5zgyK.png
    │   │   │   ├── hfYfNNtqkFzF9BE4.png
    │   │   │   ├── hu3OxByp0O4KCJft.png
    │   │   │   ├── hxUxn67g42jOHGHi.png
    │   │   │   ├── i47BmmqwUa4y0jIP.png
    │   │   │   ├── iGiF1suI8wXP6A2r.png
    │   │   │   ├── ib30bLCbBl0mKWko.png
    │   │   │   ├── j8dvLhkeL92SpOGj.png
    │   │   │   ├── jAh36hlZLpECSBHp.png
    │   │   │   ├── jCTsslbOLn04znvK.png
    │   │   │   ├── jXhwHToky4rsswCO.png
    │   │   │   ├── jYSFgcG68qqavVn6.png
    │   │   │   ├── jZe5ePOjxcQEJitP.png
    │   │   │   ├── jaxChUvakWAN9eTs.png
    │   │   │   ├── jl6AlteXSalbS3rG.png
    │   │   │   ├── jqQlxUsZOssnmdWL.png
    │   │   │   ├── k5n1w4gdm1G27rDk.png
    │   │   │   ├── k9d5xaurp8JC9DXp.png
    │   │   │   ├── kVKp9kJji4urjoMs.png
    │   │   │   ├── kdPdOkLZZW1UnOPw.png
    │   │   │   ├── keyl4nDZLxLORnr3.png
    │   │   │   ├── khFWD3MPEKPitVyA.png
    │   │   │   ├── kmBByXdkwf5Vro8P.png
    │   │   │   ├── knWd03lNhoAUPdKX.png
    │   │   │   ├── kz9TBAHLFXGnHCiF.png
    │   │   │   ├── l7pEq6tQKyUNL3GN.png
    │   │   │   ├── lGIPlKIVgwrDC17U.png
    │   │   │   ├── lZkRVz5sifz7CD66.png
    │   │   │   ├── lb8kepfzcnutbQI1.png
    │   │   │   ├── ldG6HLXeY0KilKyr.png
    │   │   │   ├── ldGrLw1rlUq1nHuw.png
    │   │   │   ├── lhr6oNI2jMsi0Z6A.png
    │   │   │   ├── lj8o8xy1TAOMQDaH.png
    │   │   │   ├── lqo55attrFxuKqlu.png
    │   │   │   ├── lxWEYgTaWJSoYSiD.png
    │   │   │   ├── m4BUXxtLrhnsSUJ2.png
    │   │   │   ├── mK7Kqflg12vHFBEK.png
    │   │   │   ├── mUqkjFi6NBsHR7tf.png
    │   │   │   ├── mV9vc1ITH1PrrbF8.png
    │   │   │   ├── mWtDBJ2pprz96x22.png
    │   │   │   ├── mZW0RUegJl9SM8ck.png
    │   │   │   ├── mkUctpckc3vjOwKa.png
    │   │   │   ├── mugG8B1m5Ra2aRgZ.png
    │   │   │   ├── n10pI9JDPyeM0P73.png
    │   │   │   ├── n1H2YStjFsCwmlYz.png
    │   │   │   ├── n5NXfZTRonR4iOr0.png
    │   │   │   ├── n8IzyztMwnfa5rjf.png
    │   │   │   ├── n9SDT7R9BSLRNCe1.png
    │   │   │   ├── nGxiCAryWhadfu7W.png
    │   │   │   ├── nOTm1e00MAJxvpwp.png
    │   │   │   ├── nPEUpKKphLYH3Bjy.png
    │   │   │   ├── nSfRj8Sp6S0GsMVm.png
    │   │   │   ├── nXOxF15xZFtfflkL.png
    │   │   │   ├── nb6CUTNhXBAmjFp9.png
    │   │   │   ├── neo7ALjpzKdzVCj1.png
    │   │   │   ├── ngFDxBhhLQzs7JAH.png
    │   │   │   ├── nmkNauqVsM2JUvok.png
    │   │   │   ├── nnf5jELXQuneoejn.png
    │   │   │   ├── nsbCG572TtIVkjKn.png
    │   │   │   ├── ntumvg6vWpT6qIal.png
    │   │   │   ├── nvCwoV9k3ym5N0JA.png
    │   │   │   ├── o0CfvFooVIcHCGzO.png
    │   │   │   ├── oAvUHooYsSpFid0p.png
    │   │   │   ├── oBKuveyTYAhqtKSw.png
    │   │   │   ├── oJi50DvlvFg4wTio.png
    │   │   │   ├── oKx22gb6XjI0aXHR.png
    │   │   │   ├── oLcpS2BYyqZLBj9P.png
    │   │   │   ├── oTQjuZyEM7y9MlNJ.png
    │   │   │   ├── oWI7JL85eXDhRFcV.png
    │   │   │   ├── ocaU2HmemX7rmjm0.png
    │   │   │   ├── oi2e7ny5y00NBLOx.png
    │   │   │   ├── oiJhtTsTDkiAcHeR.png
    │   │   │   ├── ojF0xyUvkvV3iujz.png
    │   │   │   ├── oqJ2wJHOLMGGxdjF.png
    │   │   │   ├── orYuZ7NeWdENNt7D.png
    │   │   │   ├── owYHB2dx7ExdKxsR.png
    │   │   │   ├── p2UN3r1vWk57uVqX.png
    │   │   │   ├── p2Y8kJZKuaHvM4dk.png
    │   │   │   ├── p81Lb4bD6fEvkSQ0.png
    │   │   │   ├── pHx4pvFv4zXPDI1w.png
    │   │   │   ├── pMQfFsmXAu2xZuUv.png
    │   │   │   ├── pPId4ocKjlcEVsXt.png
    │   │   │   ├── pRZml1c5DSIzYVxA.png
    │   │   │   ├── pUCjvjdpH5HSaWxl.png
    │   │   │   ├── pVCqrp8S6Ze3DAI8.png
    │   │   │   ├── pW8TQWh9SoWh0HLE.png
    │   │   │   ├── pYvpGm431tLNheln.png
    │   │   │   ├── pfyaiU10n2EvAwgw.png
    │   │   │   ├── prCirglnpqZ4KRmM.png
    │   │   │   ├── pt2EHjG6vxV6Hjmf.png
    │   │   │   ├── pwM1GeKjG7KE4i75.png
    │   │   │   ├── q35FqG8h9VCDbQ1J.png
    │   │   │   ├── qC5sV6TzOBzyzW0p.png
    │   │   │   ├── qGf97ZWPmGYzlTpo.png
    │   │   │   ├── qM0f6IJPDfLRpo1d.png
    │   │   │   ├── qQim08vMQ6OUCtbR.png
    │   │   │   ├── qRNjm8INtwezm9Yd.png
    │   │   │   ├── qVqPFRhMJXPFh8Yb.png
    │   │   │   ├── qWHWCHG7exZiCfdq.png
    │   │   │   ├── qZX4Zcms0Ffpe8v7.png
    │   │   │   ├── qbWKhamyFLSmXCgZ.png
    │   │   │   ├── qhhaVBNDIWDdNR2Y.png
    │   │   │   ├── qjNwQMtSzoZKXOGe.png
    │   │   │   ├── qs7Zi0icFErU0fsZ.png
    │   │   │   ├── qsRQNgddFhV2Mlnn.png
    │   │   │   ├── qtYZl1WPMxaH5KQV.png
    │   │   │   ├── qtfGt3JjA0Orrg9v.png
    │   │   │   ├── r98ovEGxFpCnVnyy.png
    │   │   │   ├── r9sXHEyVJVCtshSA.png
    │   │   │   ├── rDfjA9TE0tYqzT21.png
    │   │   │   ├── rSRKkten7Ffx6bEj.png
    │   │   │   ├── rX4dcSySbz56p4dk.png
    │   │   │   ├── raSxG3GjqMrYHvgW.png
    │   │   │   ├── rffdDFsMVDDkn32c.png
    │   │   │   ├── rrSpAVrlixKrTC1T.png
    │   │   │   ├── s4dtRIGK3emNyjrO.png
    │   │   │   ├── s73bLQf6K0lw4RDJ.png
    │   │   │   ├── sAEYBhcNfJgAZTD6.png
    │   │   │   ├── sDAWCwVlT2NFpEAf.png
    │   │   │   ├── sZyZICXHv0ArIZFw.png
    │   │   │   ├── sak9CBkECbg1PSLz.png
    │   │   │   ├── sisDkUJdIN7AkgTV.png
    │   │   │   ├── svY0FVnjij1nSJDK.png
    │   │   │   ├── t2SdNfWDiXGLJPBA.png
    │   │   │   ├── t3gTGwl94iLuZL1k.png
    │   │   │   ├── tFuz8mF78pYT6hKS.png
    │   │   │   ├── tHitLUmmXOyChXOH.png
    │   │   │   ├── tUAXecVWvaYBm4s4.png
    │   │   │   ├── tV2VtZHsIL8Gj4TC.png
    │   │   │   ├── tW1oIjn0hlGLToAY.png
    │   │   │   ├── tfMCcOsRUhEJZF6I.png
    │   │   │   ├── tiS1ECooPwR5IvFK.png
    │   │   │   ├── tlZ31lJJt1OhSr0a.png
    │   │   │   ├── to1CYeerlgzyJIeO.png
    │   │   │   ├── tsfjaR5pzLN4vfRW.png
    │   │   │   ├── u5672IrPHHkppdEK.png
    │   │   │   ├── uHBQbKd9VTYWdctJ.png
    │   │   │   ├── ubb6xwgONJP3xBbv.png
    │   │   │   ├── ueuECCtQxOjHF1ij.png
    │   │   │   ├── ukOGooYiFOfJHNrx.png
    │   │   │   ├── ul2wGK0NgJXs8mHv.png
    │   │   │   ├── uoYuyEHvVLrOOmqW.png
    │   │   │   ├── v1b7FBFD4ZbLJnhB.png
    │   │   │   ├── v4pz2TAsHhtNtTAH.png
    │   │   │   ├── v6Ypsa9vPurMnl20.png
    │   │   │   ├── v6wOWeRyh3Sv5BXo.png
    │   │   │   ├── vFCd43peE8nozYko.png
    │   │   │   ├── vHbB53ZFtZoNcvAM.png
    │   │   │   ├── vPvoQzBR7Paf5Jml.png
    │   │   │   ├── vUtM1pR6f5ZdEn5a.png
    │   │   │   ├── veIFAtZUg4WYjn3N.png
    │   │   │   ├── vfKiFjWIK9JKHxLn.png
    │   │   │   ├── vvM7nA8hZJD5b9CL.png
    │   │   │   ├── w3fJMYnDDxw5q00K.png
    │   │   │   ├── wBUGgxpeb0gggcTx.png
    │   │   │   ├── wBuXrsjeqMn4ZXdn.png
    │   │   │   ├── wKiW95hiPu8zQhwV.png
    │   │   │   ├── wQQCLOgW5qXxkwli.png
    │   │   │   ├── wYsHIJDvNLDvn4m7.png
    │   │   │   ├── wdUfwC8IoQbVtqzR.png
    │   │   │   ├── wfpI2zfWOeQbwd1f.png
    │   │   │   ├── wytuIz48uLeDoGqz.png
    │   │   │   ├── x3z3E6Z2qsmW8TaH.png
    │   │   │   ├── x8fNY0V8O2CJ9vaY.png
    │   │   │   ├── xJAZ3PewpLYs4ogR.png
    │   │   │   ├── xJNBzdx479xjphEV.png
    │   │   │   ├── xR8mRBEdYAbokAEk.png
    │   │   │   ├── xhKyuxHPC3RnoLD0.png
    │   │   │   ├── xha8stYdUnt02zKI.png
    │   │   │   ├── xioDLxSWnSZ5sDbQ.png
    │   │   │   ├── xnLyw2TBZF8e2vcr.png
    │   │   │   ├── xsM5n0KOqwb5R58V.png
    │   │   │   ├── xyFhBLzUNatOchjM.png
    │   │   │   ├── y2auZRkrUIi0wvd2.png
    │   │   │   ├── y9DoLrI4Hlh2EUts.png
    │   │   │   ├── yB11HwUEuYHhVlKo.png
    │   │   │   ├── yB4dN62hOf4QeWGy.png
    │   │   │   ├── yM5JZ5J4uLeYIGOO.png
    │   │   │   ├── yPnREvUeAGYRKi7V.png
    │   │   │   ├── ySmdq2LJmCBQatvr.png
    │   │   │   ├── yUhvKMWrPQ9sJ78m.png
    │   │   │   ├── yWLbGUHRsGx5ocE9.png
    │   │   │   ├── yYba9sH9TlYCAtoo.png
    │   │   │   ├── yYiQN5jZvkGqr6C5.png
    │   │   │   ├── yaRRMcZS7JJ3xLK1.png
    │   │   │   ├── yfoLtt4c7Rzc5VOW.png
    │   │   │   ├── yhXsHSeStA2dharc.png
    │   │   │   ├── ywXiLajxMzhy7BST.png
    │   │   │   ├── zBMp6VflTDyfCqa6.png
    ...
    │   │   │       ├── FyZeQAif9VpbknFi.png
    │   │   │       ├── FzdAQgBSi3eRbR4z.png
    ...
    │   │   │       ├── K06meJWsLavqjfyX.png
    │   │   │       ├── KAXMiWZQIm1n1Hji.png
    │   │   │       ├── KCh0XBlgDa526pBe.png
    │   │   │       ├── KM8TqJbWqew79vPt.png
    ...
    │   │   │       ├── M8g1dW2y0mQxe3OR.png
    │   │   │       ├── MFG70ohG4iZ3xm3b.png
    │   │   │       ├── MFlCOcvmOe3jejwy.png
    │   │   │       ├── MGEIcCr7BQbB4xrs.png
    ...
    │   │   │       ├── gQyIUVHeIS3WYuzv.png
    │   │   │       ├── gWsh2wyYZXw7an5G.png
    ...
    │   │   │       ├── iXpTSeMxuDfhayJw.png
    │   │   │       ├── iYOrHPwEvEe7rXSL.png
    ...
    │   │   │       ├── nfqbRmCrRbEXjgfb.png
    │   │   │       ├── ngrJl9cJoUVFdYwO.png
    │   │   │       ├── ntwoVP9pgUbs3LGq.png
    ...
    │   │   │       ├── s1gqGqCAbVLwDSw8.png
    │   │   │       ├── s3L79HfHyX9tyTS0.png
    │   │   │       ├── s9hnXT0uSjC6vl6W.png
    │   │   │       ├── sC3hanWBPaeGV4xg.png
    ...
    │   │   │       ├── tHvKVZRQUsqNt0g4.png
    │   │   │       ├── tLHK08LTpqrSPnkX.png
    │   │   │       ├── tPxruYoQszERdzTA.png
    │   │   │       ├── tTOLtCt5p5upFetg.png
    ...
    │   │   │       ├── w7862CEzcIVnMgG4.png
    │   │   │       ├── wJNyEIqVDFH8bx5h.png
    │   │   │       ├── wKb3eKZpMml0XY9D.png
...
<details closed><summary>Prodigy_ML_03</summary>
...
<details closed><summary>Prodigy_ML_02</summary>
...
<details closed><summary>Prodigy_ML_01</summary>
...
<details closed><summary>Prodigy_ML_04</summary>
...
<details closed><summary>Prodigy_ML_04.Dataset</summary>
...
<details closed><summary>Prodigy_ML_04.Dataset.rps-cv-images</summary>
...
<details closed><summary>Prodigy_ML_05</summary>
...
1. **Software and Libraries**
   ...
   - **Jupyter Notebook or IDE:** For running and editing code (e.g., JupyterLab, VSCode).
   - **Libraries:** 
     - **Data Preprocessing:** Pandas, NumPy, Scikit-learn.
     - **Machine Learning:** Scikit-learn, TensorFlow/Keras (for deep learning).
     - **Data Visualization:** Matplotlib, Seaborn.
     - **Image Processing:** OpenCV (if required for image data handling).
...
2. **Hardware**
   ...
   - **Optional:** 
     - GPU (NVIDIA CUDA-compatible) for training deep learning models.

3. **Datasets**
   - **Task-Specific Datasets:** Downloadable from Kaggle:
     - [House Prices Detection](https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data)
     - [Customer Segmentation](https://www.kaggle.com/datasets/vjchoudhary7/customer-segmentation-tutorial-in-python)
...
4. **Additional Tools**
   ...
   - **Package Manager:** pip or conda (for managing Python libraries).

Ensure you have these requirements set up to effectively work with the project and execute the provided code.

### ⚙️ Installation

1. Clone the Prodigy_Intern repository:

```sh
git clone https://github.com/vasanth-boyez/Prodigy_Intern.git
```
...
### 🤖 Running Prodigy_Intern

Use the following command to run Prodigy_Intern:
...
#### **Week 1: Project Setup and Initial Tasks**

- **Day 1-2: Project Setup**
  - Set up the development environment (Python, IDE, libraries).
  - Install necessary libraries (Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, TensorFlow/Keras).
  - Download and organize datasets from Kaggle.

- **Day 3-5: Task-01 - House Price Prediction**
  - **Data Exploration and Preprocessing:**
    - Load and explore the dataset.
    - Handle missing values, encode categorical features, and normalize numerical features.
  - **Model Implementation:**
    - Implement a linear regression model.
    - Train the model and evaluate performance using metrics like MAE and R-squared.
  
- **Day 6-7: Documentation**
  - Document the process for Task-01.
  - Update README file with details about Task-01.

#### **Week 2: Middle Tasks**

- **Day 8-9: Task-02 - Customer Segmentation**
  - **Data Preprocessing:**
    - Clean and preprocess customer data.
    - Perform feature engineering and scaling.
  - **Model Implementation:**
    - Apply K-means clustering to segment customers.
    - Visualize clusters and analyze segmentation results.

- **Day 10-12: Task-03 - Image Classification of Cats and Dogs**
  - **Data Preprocessing:**
    - Resize and normalize images.
  - **Model Implementation:**
    - Implement and train an SVM model for image classification.
    - Evaluate model accuracy and performance.

- **Day 13-14: Documentation**
  - Document the process for Task-02 and Task-03.
  - Update README file with details about these tasks.

#### **Week 3: Final Tasks and Consolidation**

- **Day 15-17: Task-04 - Hand Gesture Recognition**
  - **Data Preprocessing:**
    - Prepare and preprocess hand gesture images or videos.
  - **Model Implementation:**
    - Develop and train a deep learning model (e.g., CNN) for gesture recognition.
    - Validate and optimize the model.

- **Day 18-20: Task-05 - Food Item Recognition and Calorie Estimation**
  - **Data Preprocessing:**
    - Preprocess food images and perform data augmentation if needed.
  - **Model Implementation:**
    - Implement and train a CNN model for food recognition and calorie estimation.
    - Evaluate model accuracy and performance.

- **Day 21: Final Review and Documentation**
  - Review and consolidate results from all tasks.
  - Finalize and update README file with complete project details.
  - Prepare a summary report of the entire project.
...
- **[Submit Pull Requests](https://github.com/vasanth-boyez/Prodigy_Intern.git/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
- **[Join the Discussions](https://github.com/vasanth-boyez/Prodigy_Intern.git/discussions)**: Share your insights, provide feedback, or ask questions.
- **[Report Issues](https://github.com/vasanth-boyez/Prodigy_Intern.git/issues)**: Submit bugs found or log feature requests for Prodigy_intern.
...
- ### Acknowledgments
   ...
   Thank you to Prodigy Infotech for offering this self-paced internship and providing the opportunity to explore and learn independently. I also appreciate the Kaggle community and open-source contributors for their valuable resources and tools. Special thanks to my family and friends for their support throughout this journey.
